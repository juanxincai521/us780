...
int mipi_dsi_panel_power(int on)
{
	...
	if (!dsi_power_on) {
		...
		gpio_tlmm_config(GPIO_CFG(GPIO_LCD_DSV_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
...
static struct i2c_registry vu2_i2c_backlight_device __initdata = {
		I2C_SURF | I2C_FFA | I2C_FLUID | I2C_RUMI,
		MSM_8960_GSBI2_QUP_I2C_BUS_ID,
		msm_i2c_backlight_info,
		ARRAY_SIZE(msm_i2c_backlight_info),
...
static struct platform_device *vu2_panel_devices[] __initdata = {
#ifdef CONFIG_FB_MSM_HDMI_MSM_PANEL
	&hdmi_msm_device,
#endif
#if defined(CONFIG_FB_MSM_MIPI_DSI_LGIT)
...
void __init lge_add_lcd_devices(void)
{
	...
	platform_add_devices(vu2_panel_devices, ARRAY_SIZE(vu2_panel_devices));
	lge_add_msm_i2c_device(&vu2_i2c_backlight_device);
	msm8960_init_fb();
}
