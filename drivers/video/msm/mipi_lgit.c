...
{	*/
	...
	if(lgit_change_panel)
		ret = mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set1,
			ARRAY_SIZE(lgit_power_on_set1));
	else
		ret = mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set1_change,
	...
	ret = mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set2,
	...
	ret = mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set3,
